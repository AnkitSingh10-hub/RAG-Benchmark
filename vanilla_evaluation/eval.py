...
from vanilla_evaluation.test import TestQuestion, load_tests
...
# implementation/answer.py has no rerank step — it retrieves straight from
# the Chroma retriever with search_kwargs={"k": 10}. Mirror that value here
# so precision/recall@k line up with what's actually sent to the LLM.
RETRIEVAL_K = 10
